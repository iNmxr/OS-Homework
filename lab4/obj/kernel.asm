...
ffffffffc0200048:	e406                	sd	ra,8(sp)
    memset(edata, 0, end - edata);
ffffffffc020004a:	645040ef          	jal	ra,ffffffffc0204e8e <memset>
...
ffffffffc0200056:	e8e58593          	addi	a1,a1,-370 # ffffffffc0204ee0 <etext+0x4>
ffffffffc020005a:	00005517          	auipc	a0,0x5
ffffffffc020005e:	ea650513          	addi	a0,a0,-346 # ffffffffc0204f00 <etext+0x24>
...
ffffffffc02000ac:	e6050513          	addi	a0,a0,-416 # ffffffffc0204f08 <etext+0x2c>
...
ffffffffc0200172:	c602                	sw	zero,12(sp)
    vprintfmt((void*)cputch, &cnt, fmt, ap);
ffffffffc0200174:	11d040ef          	jal	ra,ffffffffc0204a90 <vprintfmt>
    return cnt;
}
...
ffffffffc02001a8:	c202                	sw	zero,4(sp)
    vprintfmt((void*)cputch, &cnt, fmt, ap);
ffffffffc02001aa:	0e7040ef          	jal	ra,ffffffffc0204a90 <vprintfmt>
    cnt = vcprintf(fmt, ap);
    va_end(ap);
    return cnt;
}
...
ffffffffc02001ce:	d4650513          	addi	a0,a0,-698 # ffffffffc0204f10 <etext+0x34>
void print_kerninfo(void) {
...
ffffffffc02001e4:	d5050513          	addi	a0,a0,-688 # ffffffffc0204f30 <etext+0x54>
ffffffffc02001e8:	f99ff0ef          	jal	ra,ffffffffc0200180 <cprintf>
    cprintf("  etext  0x%08x (virtual)\n", etext);
ffffffffc02001ec:	00005597          	auipc	a1,0x5
ffffffffc02001f0:	cf058593          	addi	a1,a1,-784 # ffffffffc0204edc <etext>
ffffffffc02001f4:	00005517          	auipc	a0,0x5
ffffffffc02001f8:	d5c50513          	addi	a0,a0,-676 # ffffffffc0204f50 <etext+0x74>
...
ffffffffc020020c:	d6850513          	addi	a0,a0,-664 # ffffffffc0204f70 <etext+0x94>
...
ffffffffc0200220:	d7450513          	addi	a0,a0,-652 # ffffffffc0204f90 <etext+0xb4>
...
ffffffffc020024e:	d6650513          	addi	a0,a0,-666 # ffffffffc0204fb0 <etext+0xd4>
}
...
ffffffffc020025c:	d8860613          	addi	a2,a2,-632 # ffffffffc0204fe0 <etext+0x104>
ffffffffc0200260:	04d00593          	li	a1,77
ffffffffc0200264:	00005517          	auipc	a0,0x5
ffffffffc0200268:	d9450513          	addi	a0,a0,-620 # ffffffffc0204ff8 <etext+0x11c>
void print_stackframe(void) {
...
ffffffffc0200278:	d9c60613          	addi	a2,a2,-612 # ffffffffc0205010 <etext+0x134>
ffffffffc020027c:	00005597          	auipc	a1,0x5
ffffffffc0200280:	db458593          	addi	a1,a1,-588 # ffffffffc0205030 <etext+0x154>
ffffffffc0200284:	00005517          	auipc	a0,0x5
ffffffffc0200288:	db450513          	addi	a0,a0,-588 # ffffffffc0205038 <etext+0x15c>
mon_help(int argc, char **argv, struct trapframe *tf) {
...
ffffffffc0200296:	db660613          	addi	a2,a2,-586 # ffffffffc0205048 <etext+0x16c>
ffffffffc020029a:	00005597          	auipc	a1,0x5
ffffffffc020029e:	dd658593          	addi	a1,a1,-554 # ffffffffc0205070 <etext+0x194>
ffffffffc02002a2:	00005517          	auipc	a0,0x5
ffffffffc02002a6:	d9650513          	addi	a0,a0,-618 # ffffffffc0205038 <etext+0x15c>
ffffffffc02002aa:	ed7ff0ef          	jal	ra,ffffffffc0200180 <cprintf>
ffffffffc02002ae:	00005617          	auipc	a2,0x5
ffffffffc02002b2:	dd260613          	addi	a2,a2,-558 # ffffffffc0205080 <etext+0x1a4>
ffffffffc02002b6:	00005597          	auipc	a1,0x5
ffffffffc02002ba:	dea58593          	addi	a1,a1,-534 # ffffffffc02050a0 <etext+0x1c4>
ffffffffc02002be:	00005517          	auipc	a0,0x5
ffffffffc02002c2:	d7a50513          	addi	a0,a0,-646 # ffffffffc0205038 <etext+0x15c>
...
ffffffffc02002fc:	db850513          	addi	a0,a0,-584 # ffffffffc02050b0 <etext+0x1d4>
kmonitor(struct trapframe *tf) {
...
ffffffffc020031e:	dbe50513          	addi	a0,a0,-578 # ffffffffc02050d8 <etext+0x1fc>
...
ffffffffc0200348:	dbc90913          	addi	s2,s2,-580 # ffffffffc0205100 <etext+0x224>
        while (*buf != '\0' && strchr(WHITESPACE, *buf) != NULL) {
ffffffffc020034c:	00005497          	auipc	s1,0x5
ffffffffc0200350:	dbc48493          	addi	s1,s1,-580 # ffffffffc0205108 <etext+0x22c>
        if (argc == MAXARGS - 1) {
ffffffffc0200354:	49bd                	li	s3,15
            cprintf("Too many arguments (max %d).\n", MAXARGS);
ffffffffc0200356:	00005b17          	auipc	s6,0x5
ffffffffc020035a:	dbab0b13          	addi	s6,s6,-582 # ffffffffc0205110 <etext+0x234>
        argv[argc ++] = buf;
ffffffffc020035e:	00005a17          	auipc	s4,0x5
ffffffffc0200362:	cd2a0a13          	addi	s4,s4,-814 # ffffffffc0205030 <etext+0x154>
    for (i = 0; i < NCOMMANDS; i ++) {
...
ffffffffc020038c:	0d61                	addi	s10,s10,24
        if (strcmp(commands[i].name, argv[0]) == 0) {
ffffffffc020038e:	2cd040ef          	jal	ra,ffffffffc0204e5a <strcmp>
...
ffffffffc02003a0:	0d61                	addi	s10,s10,24
        if (strcmp(commands[i].name, argv[0]) == 0) {
ffffffffc02003a2:	2b9040ef          	jal	ra,ffffffffc0204e5a <strcmp>
...
ffffffffc02003e0:	299040ef          	jal	ra,ffffffffc0204e78 <strchr>
...
ffffffffc020041e:	25b040ef          	jal	ra,ffffffffc0204e78 <strchr>
...
ffffffffc020043c:	cf850513          	addi	a0,a0,-776 # ffffffffc0205130 <etext+0x254>
...
ffffffffc020058a:	e406                	sd	ra,8(sp)
    memcpy(dst, &ide[iobase], nsecs * SECTSIZE);
ffffffffc020058c:	115040ef          	jal	ra,ffffffffc0204ea0 <memcpy>
    return 0;
}
...
ffffffffc02005ae:	e406                	sd	ra,8(sp)
    memcpy(&ide[iobase], src, nsecs * SECTSIZE);
ffffffffc02005b0:	0f1040ef          	jal	ra,ffffffffc0204ea0 <memcpy>
    return 0;
}
...
ffffffffc0200c2e:	39663603          	ld	a2,918(a2) # ffffffffc0206fc0 <nbase>
...
ffffffffc02016f4:	8d06b683          	ld	a3,-1840(a3) # ffffffffc0206fc0 <nbase>
...
ffffffffc0201968:	65c53503          	ld	a0,1628(a0) # ffffffffc0206fc0 <nbase>
...
ffffffffc0201bbe:	2d0030ef          	jal	ra,ffffffffc0204e8e <memset>
    return page - pages + nbase;
...
ffffffffc0201c50:	23e030ef          	jal	ra,ffffffffc0204e8e <memset>
    return page - pages + nbase;
...
ffffffffc0202352:	2f7020ef          	jal	ra,ffffffffc0204e48 <strcpy>
    assert(strcmp((void *)0x100, (void *)(0x100 + PGSIZE)) == 0);
ffffffffc0202356:	10040593          	addi	a1,s0,256
ffffffffc020235a:	10000513          	li	a0,256
ffffffffc020235e:	2fd020ef          	jal	ra,ffffffffc0204e5a <strcmp>
...
ffffffffc0202390:	10068023          	sb	zero,256(a3)
    assert(strlen((const char *)0x100) == 0);
ffffffffc0202394:	27f020ef          	jal	ra,ffffffffc0204e12 <strlen>
...
ffffffffc0202e2c:	19860613          	addi	a2,a2,408 # ffffffffc0206fc0 <nbase>
...
ffffffffc0203cc2:	302a3a03          	ld	s4,770(s4) # ffffffffc0206fc0 <nbase>
...
ffffffffc0204080:	aa450513          	addi	a0,a0,-1372 # ffffffffc0206b20 <default_pmm_manager+0xef0>
...
ffffffffc0204092:	a4250513          	addi	a0,a0,-1470 # ffffffffc0206ad0 <default_pmm_manager+0xea0>
...
ffffffffc02040a2:	aaa50513          	addi	a0,a0,-1366 # ffffffffc0206b48 <default_pmm_manager+0xf18>
...
ffffffffc02040b2:	a5250513          	addi	a0,a0,-1454 # ffffffffc0206b00 <default_pmm_manager+0xed0>
...
ffffffffc02040e4:	a9060613          	addi	a2,a2,-1392 # ffffffffc0206b70 <default_pmm_manager+0xf40>
ffffffffc02040e8:	45b5                	li	a1,13
ffffffffc02040ea:	00003517          	auipc	a0,0x3
ffffffffc02040ee:	aa650513          	addi	a0,a0,-1370 # ffffffffc0206b90 <default_pmm_manager+0xf60>
...
ffffffffc020411e:	ea673703          	ld	a4,-346(a4) # ffffffffc0206fc0 <nbase>
...
ffffffffc0204158:	a5460613          	addi	a2,a2,-1452 # ffffffffc0206ba8 <default_pmm_manager+0xf78>
ffffffffc020415c:	45d1                	li	a1,20
ffffffffc020415e:	00003517          	auipc	a0,0x3
ffffffffc0204162:	a3250513          	addi	a0,a0,-1486 # ffffffffc0206b90 <default_pmm_manager+0xf60>
...
ffffffffc0204174:	af860613          	addi	a2,a2,-1288 # ffffffffc0205c68 <default_pmm_manager+0x38>
ffffffffc0204178:	00002517          	auipc	a0,0x2
ffffffffc020417c:	b1850513          	addi	a0,a0,-1256 # ffffffffc0205c90 <default_pmm_manager+0x60>
...
ffffffffc02041ac:	e1873703          	ld	a4,-488(a4) # ffffffffc0206fc0 <nbase>
...
ffffffffc02041e6:	9c660613          	addi	a2,a2,-1594 # ffffffffc0206ba8 <default_pmm_manager+0xf78>
ffffffffc02041ea:	45e5                	li	a1,25
ffffffffc02041ec:	00003517          	auipc	a0,0x3
ffffffffc02041f0:	9a450513          	addi	a0,a0,-1628 # ffffffffc0206b90 <default_pmm_manager+0xf60>
...
ffffffffc0204202:	a6a60613          	addi	a2,a2,-1430 # ffffffffc0205c68 <default_pmm_manager+0x38>
ffffffffc0204206:	00002517          	auipc	a0,0x2
ffffffffc020420a:	a8a50513          	addi	a0,a0,-1398 # ffffffffc0205c90 <default_pmm_manager+0x60>
...
// 该函数负责分配并返回一个新的proc_struct结构体，用于存储新建立的内核线程的管理信息。
...
ffffffffc0204230:	e11c                	sd	a5,0(a0)
    ...
    proc->kstack = 0;                                    // 内核进程栈
    proc->need_resched = 0;                              // 不需调度
    proc->parent = NULL;                                 // 在内核中，只有内核创建的idle进程没有父进程，其他进程都有父进程。
    proc->mm = NULL;                                     // 保存内存管理信息，包括内存映射，虚存管理等内容。
    memset(&(proc->context), 0, sizeof(struct context)); // 保存进程执行的上下文，也就是几个关键的寄存器的值。
...
ffffffffc0204250:	43f000ef          	jal	ra,ffffffffc0204e8e <memset>
    proc->tf = NULL;                                     // 保存进程的中断帧。当进程从用户空间跳进内核空间的时候，进程的执行状态保存在中断帧中
    proc->cr3 = boot_cr3;                                // CR3寄存器: 保存PDT基址。
...
ffffffffc020426e:	421000ef          	jal	ra,ffffffffc0204e8e <memset>
    }
    return proc;
}
...
ffffffffc02042d8:	91c50513          	addi	a0,a0,-1764 # ffffffffc0206bf0 <default_pmm_manager+0xfc0>
ffffffffc02042dc:	ea5fb0ef          	jal	ra,ffffffffc0200180 <cprintf>
    cprintf("To U: \"en.., Bye, Bye. :)\"\n");
ffffffffc02042e0:	00003517          	auipc	a0,0x3
ffffffffc02042e4:	92050513          	addi	a0,a0,-1760 # ffffffffc0206c00 <default_pmm_manager+0xfd0>
...
ffffffffc02042fe:	f026                	sd	s1,32(sp)
    if (proc != current) {
ffffffffc0204300:	00011497          	auipc	s1,0x11
ffffffffc0204304:	2b048493          	addi	s1,s1,688 # ffffffffc02155b0 <current>
...
ffffffffc0204336:	5a8000ef          	jal	ra,ffffffffc02048de <switch_to>
    if (flag) {
...
ffffffffc0204366:	00011497          	auipc	s1,0x11
ffffffffc020436a:	26248493          	addi	s1,s1,610 # ffffffffc02155c8 <nr_process>
...
ffffffffc020437a:	20f75c63          	bge	a4,a5,ffffffffc0204592 <do_fork+0x230>
ffffffffc020437e:	892e                	mv	s2,a1
ffffffffc0204380:	8432                	mv	s0,a2
    if ((proc = alloc_proc()) == NULL)        // 获得一块用户信息块
ffffffffc0204382:	e99ff0ef          	jal	ra,ffffffffc020421a <alloc_proc>
ffffffffc0204386:	89aa                	mv	s3,a0
ffffffffc0204388:	20050a63          	beqz	a0,ffffffffc020459c <do_fork+0x23a>
    struct Page *page = alloc_pages(KSTACKPAGE);
ffffffffc020438c:	4509                	li	a0,2
ffffffffc020438e:	e9efd0ef          	jal	ra,ffffffffc0201a2c <alloc_pages>
    if (page != NULL) {
ffffffffc0204392:	1a050a63          	beqz	a0,ffffffffc0204546 <do_fork+0x1e4>
    return page - pages + nbase;
ffffffffc0204396:	00011697          	auipc	a3,0x11
ffffffffc020439a:	1da6b683          	ld	a3,474(a3) # ffffffffc0215570 <pages>
ffffffffc020439e:	40d506b3          	sub	a3,a0,a3
ffffffffc02043a2:	8699                	srai	a3,a3,0x6
ffffffffc02043a4:	00003517          	auipc	a0,0x3
ffffffffc02043a8:	c1c53503          	ld	a0,-996(a0) # ffffffffc0206fc0 <nbase>
ffffffffc02043ac:	96aa                	add	a3,a3,a0
    return KADDR(page2pa(page));
ffffffffc02043ae:	00c69793          	slli	a5,a3,0xc
ffffffffc02043b2:	83b1                	srli	a5,a5,0xc
ffffffffc02043b4:	00011717          	auipc	a4,0x11
ffffffffc02043b8:	1b473703          	ld	a4,436(a4) # ffffffffc0215568 <npage>
    return page2ppn(page) << PGSHIFT;
ffffffffc02043bc:	06b2                	slli	a3,a3,0xc
    return KADDR(page2pa(page));
ffffffffc02043be:	20e7f163          	bgeu	a5,a4,ffffffffc02045c0 <do_fork+0x25e>
    assert(current->mm == NULL);
ffffffffc02043c2:	00011797          	auipc	a5,0x11
ffffffffc02043c6:	1ee7b783          	ld	a5,494(a5) # ffffffffc02155b0 <current>
ffffffffc02043ca:	779c                	ld	a5,40(a5)
ffffffffc02043cc:	00011717          	auipc	a4,0x11
ffffffffc02043d0:	1b473703          	ld	a4,436(a4) # ffffffffc0215580 <va_pa_offset>
ffffffffc02043d4:	96ba                	add	a3,a3,a4
        proc->kstack = (uintptr_t)page2kva(page);
ffffffffc02043d6:	00d9b823          	sd	a3,16(s3)
    assert(current->mm == NULL);
ffffffffc02043da:	1c079363          	bnez	a5,ffffffffc02045a0 <do_fork+0x23e>
    proc->tf = (struct trapframe *)(proc->kstack + KSTACKSIZE - sizeof(struct trapframe));
ffffffffc02043de:	6789                	lui	a5,0x2
ffffffffc02043e0:	ee078793          	addi	a5,a5,-288 # 1ee0 <kern_entry-0xffffffffc01fe120>
ffffffffc02043e4:	96be                	add	a3,a3,a5
    *(proc->tf) = *tf;
ffffffffc02043e6:	8622                	mv	a2,s0
    proc->tf = (struct trapframe *)(proc->kstack + KSTACKSIZE - sizeof(struct trapframe));
ffffffffc02043e8:	0ad9b023          	sd	a3,160(s3)
    *(proc->tf) = *tf;
ffffffffc02043ec:	87b6                	mv	a5,a3
ffffffffc02043ee:	12040893          	addi	a7,s0,288
ffffffffc02043f2:	00063803          	ld	a6,0(a2)
ffffffffc02043f6:	6608                	ld	a0,8(a2)
ffffffffc02043f8:	6a0c                	ld	a1,16(a2)
ffffffffc02043fa:	6e18                	ld	a4,24(a2)
ffffffffc02043fc:	0107b023          	sd	a6,0(a5)
ffffffffc0204400:	e788                	sd	a0,8(a5)
ffffffffc0204402:	eb8c                	sd	a1,16(a5)
ffffffffc0204404:	ef98                	sd	a4,24(a5)
ffffffffc0204406:	02060613          	addi	a2,a2,32
ffffffffc020440a:	02078793          	addi	a5,a5,32
ffffffffc020440e:	ff1612e3          	bne	a2,a7,ffffffffc02043f2 <do_fork+0x90>
    proc->tf->gpr.a0 = 0;
ffffffffc0204412:	0406b823          	sd	zero,80(a3)
    proc->tf->gpr.sp = (esp == 0) ? (uintptr_t)proc->tf : esp;
ffffffffc0204416:	10090c63          	beqz	s2,ffffffffc020452e <do_fork+0x1cc>
    if (++ last_pid >= MAX_PID) {
ffffffffc020441a:	00006817          	auipc	a6,0x6
ffffffffc020441e:	c3e80813          	addi	a6,a6,-962 # ffffffffc020a058 <last_pid.1>
ffffffffc0204422:	00082783          	lw	a5,0(a6)
    proc->tf->gpr.sp = (esp == 0) ? (uintptr_t)proc->tf : esp;
ffffffffc0204426:	0126b823          	sd	s2,16(a3)
    proc->context.ra = (uintptr_t)forkret;
ffffffffc020442a:	00000717          	auipc	a4,0x0
ffffffffc020442e:	e5270713          	addi	a4,a4,-430 # ffffffffc020427c <forkret>
    if (++ last_pid >= MAX_PID) {
ffffffffc0204432:	0017851b          	addiw	a0,a5,1
    proc->context.ra = (uintptr_t)forkret;
ffffffffc0204436:	02e9b823          	sd	a4,48(s3)
    proc->context.sp = (uintptr_t)(proc->tf);
ffffffffc020443a:	02d9bc23          	sd	a3,56(s3)
    if (++ last_pid >= MAX_PID) {
ffffffffc020443e:	00a82023          	sw	a0,0(a6)
ffffffffc0204442:	6789                	lui	a5,0x2
ffffffffc0204444:	06f55e63          	bge	a0,a5,ffffffffc02044c0 <do_fork+0x15e>
    if (last_pid >= next_safe) {
ffffffffc0204448:	00006317          	auipc	t1,0x6
ffffffffc020444c:	c1430313          	addi	t1,t1,-1004 # ffffffffc020a05c <next_safe.0>
ffffffffc0204450:	00032783          	lw	a5,0(t1)
ffffffffc0204454:	00011417          	auipc	s0,0x11
ffffffffc0204458:	0d440413          	addi	s0,s0,212 # ffffffffc0215528 <proc_list>
ffffffffc020445c:	06f55a63          	bge	a0,a5,ffffffffc02044d0 <do_fork+0x16e>
    list_add(hash_list + pid_hashfn(proc->pid), &(proc->hash_link));
ffffffffc0204460:	45a9                	li	a1,10
    proc->pid = get_pid();                    // 为新进程分配pid
ffffffffc0204462:	00a9a223          	sw	a0,4(s3)
    list_add(hash_list + pid_hashfn(proc->pid), &(proc->hash_link));
ffffffffc0204466:	2501                	sext.w	a0,a0
ffffffffc0204468:	5a6000ef          	jal	ra,ffffffffc0204a0e <hash32>
ffffffffc020446c:	02051793          	slli	a5,a0,0x20
ffffffffc0204470:	01c7d513          	srli	a0,a5,0x1c
ffffffffc0204474:	0000d797          	auipc	a5,0xd
ffffffffc0204478:	0a478793          	addi	a5,a5,164 # ffffffffc0211518 <hash_list>
ffffffffc020447c:	953e                	add	a0,a0,a5
    __list_add(elm, listelm, listelm->next);
ffffffffc020447e:	6518                	ld	a4,8(a0)
ffffffffc0204480:	0d898793          	addi	a5,s3,216
ffffffffc0204484:	6414                	ld	a3,8(s0)
    prev->next = next->prev = elm;
ffffffffc0204486:	e31c                	sd	a5,0(a4)
ffffffffc0204488:	e51c                	sd	a5,8(a0)
    nr_process += 1;
ffffffffc020448a:	409c                	lw	a5,0(s1)
    elm->next = next;
ffffffffc020448c:	0ee9b023          	sd	a4,224(s3)
    elm->prev = prev;
ffffffffc0204490:	0ca9bc23          	sd	a0,216(s3)
    list_add(&proc_list, &(proc->list_link)); // 将新进程添加到进程列表
ffffffffc0204494:	0c898713          	addi	a4,s3,200
    prev->next = next->prev = elm;
ffffffffc0204498:	e298                	sd	a4,0(a3)
    nr_process += 1;
ffffffffc020449a:	2785                	addiw	a5,a5,1
    wakeup_proc(proc);                        // 唤醒新进程
ffffffffc020449c:	854e                	mv	a0,s3
    elm->next = next;
ffffffffc020449e:	0cd9b823          	sd	a3,208(s3)
    elm->prev = prev;
ffffffffc02044a2:	0c89b423          	sd	s0,200(s3)
    prev->next = next->prev = elm;
ffffffffc02044a6:	e418                	sd	a4,8(s0)
    nr_process += 1;
ffffffffc02044a8:	c09c                	sw	a5,0(s1)
    wakeup_proc(proc);                        // 唤醒新进程
ffffffffc02044aa:	49e000ef          	jal	ra,ffffffffc0204948 <wakeup_proc>
    ret = proc->pid;                          // 返回新进程号
ffffffffc02044ae:	0049a503          	lw	a0,4(s3)
}
ffffffffc02044b2:	70a2                	ld	ra,40(sp)
ffffffffc02044b4:	7402                	ld	s0,32(sp)
ffffffffc02044b6:	64e2                	ld	s1,24(sp)
ffffffffc02044b8:	6942                	ld	s2,16(sp)
ffffffffc02044ba:	69a2                	ld	s3,8(sp)
ffffffffc02044bc:	6145                	addi	sp,sp,48
ffffffffc02044be:	8082                	ret
        last_pid = 1;
ffffffffc02044c0:	4785                	li	a5,1
ffffffffc02044c2:	00f82023          	sw	a5,0(a6)
        goto inside;
ffffffffc02044c6:	4505                	li	a0,1
ffffffffc02044c8:	00006317          	auipc	t1,0x6
ffffffffc02044cc:	b9430313          	addi	t1,t1,-1132 # ffffffffc020a05c <next_safe.0>
    return listelm->next;
ffffffffc02044d0:	00011417          	auipc	s0,0x11
ffffffffc02044d4:	05840413          	addi	s0,s0,88 # ffffffffc0215528 <proc_list>
ffffffffc02044d8:	00843e03          	ld	t3,8(s0)
        next_safe = MAX_PID;
ffffffffc02044dc:	6789                	lui	a5,0x2
ffffffffc02044de:	00f32023          	sw	a5,0(t1)
ffffffffc02044e2:	86aa                	mv	a3,a0
ffffffffc02044e4:	4581                	li	a1,0
        while ((le = list_next(le)) != list) {
ffffffffc02044e6:	6e89                	lui	t4,0x2
ffffffffc02044e8:	048e0a63          	beq	t3,s0,ffffffffc020453c <do_fork+0x1da>
ffffffffc02044ec:	88ae                	mv	a7,a1
ffffffffc02044ee:	87f2                	mv	a5,t3
ffffffffc02044f0:	6609                	lui	a2,0x2
ffffffffc02044f2:	a811                	j	ffffffffc0204506 <do_fork+0x1a4>
            else if (proc->pid > last_pid && next_safe > proc->pid) {
ffffffffc02044f4:	00e6d663          	bge	a3,a4,ffffffffc0204500 <do_fork+0x19e>
ffffffffc02044f8:	00c75463          	bge	a4,a2,ffffffffc0204500 <do_fork+0x19e>
ffffffffc02044fc:	863a                	mv	a2,a4
ffffffffc02044fe:	4885                	li	a7,1
ffffffffc0204500:	679c                	ld	a5,8(a5)
        while ((le = list_next(le)) != list) {
ffffffffc0204502:	00878d63          	beq	a5,s0,ffffffffc020451c <do_fork+0x1ba>
            if (proc->pid == last_pid) {
ffffffffc0204506:	f3c7a703          	lw	a4,-196(a5) # 1f3c <kern_entry-0xffffffffc01fe0c4>
ffffffffc020450a:	fed715e3          	bne	a4,a3,ffffffffc02044f4 <do_fork+0x192>
                if (++ last_pid >= next_safe) {
ffffffffc020450e:	2685                	addiw	a3,a3,1
ffffffffc0204510:	02c6d163          	bge	a3,a2,ffffffffc0204532 <do_fork+0x1d0>
ffffffffc0204514:	679c                	ld	a5,8(a5)
ffffffffc0204516:	4585                	li	a1,1
        while ((le = list_next(le)) != list) {
ffffffffc0204518:	fe8797e3          	bne	a5,s0,ffffffffc0204506 <do_fork+0x1a4>
ffffffffc020451c:	c581                	beqz	a1,ffffffffc0204524 <do_fork+0x1c2>
ffffffffc020451e:	00d82023          	sw	a3,0(a6)
ffffffffc0204522:	8536                	mv	a0,a3
ffffffffc0204524:	f2088ee3          	beqz	a7,ffffffffc0204460 <do_fork+0xfe>
ffffffffc0204528:	00c32023          	sw	a2,0(t1)
ffffffffc020452c:	bf15                	j	ffffffffc0204460 <do_fork+0xfe>
    proc->tf->gpr.sp = (esp == 0) ? (uintptr_t)proc->tf : esp;
ffffffffc020452e:	8936                	mv	s2,a3
ffffffffc0204530:	b5ed                	j	ffffffffc020441a <do_fork+0xb8>
                    if (last_pid >= MAX_PID) {
ffffffffc0204532:	01d6c363          	blt	a3,t4,ffffffffc0204538 <do_fork+0x1d6>
                        last_pid = 1;
ffffffffc0204536:	4685                	li	a3,1
                    goto repeat;
ffffffffc0204538:	4585                	li	a1,1
ffffffffc020453a:	b77d                	j	ffffffffc02044e8 <do_fork+0x186>
ffffffffc020453c:	cda9                	beqz	a1,ffffffffc0204596 <do_fork+0x234>
ffffffffc020453e:	00d82023          	sw	a3,0(a6)
    return last_pid;
ffffffffc0204542:	8536                	mv	a0,a3
ffffffffc0204544:	bf31                	j	ffffffffc0204460 <do_fork+0xfe>
    free_pages(kva2page((void *)(proc->kstack)), KSTACKPAGE);
ffffffffc0204546:	0109b683          	ld	a3,16(s3)
    return pa2page(PADDR(kva));
ffffffffc020454a:	c02007b7          	lui	a5,0xc0200
ffffffffc020454e:	0af6e163          	bltu	a3,a5,ffffffffc02045f0 <do_fork+0x28e>
ffffffffc0204552:	00011797          	auipc	a5,0x11
ffffffffc0204556:	02e7b783          	ld	a5,46(a5) # ffffffffc0215580 <va_pa_offset>
ffffffffc020455a:	40f687b3          	sub	a5,a3,a5
    if (PPN(pa) >= npage) {
ffffffffc020455e:	83b1                	srli	a5,a5,0xc
ffffffffc0204560:	00011717          	auipc	a4,0x11
ffffffffc0204564:	00873703          	ld	a4,8(a4) # ffffffffc0215568 <npage>
ffffffffc0204568:	06e7f863          	bgeu	a5,a4,ffffffffc02045d8 <do_fork+0x276>
    return &pages[PPN(pa) - nbase];
ffffffffc020456c:	00003717          	auipc	a4,0x3
ffffffffc0204570:	a5473703          	ld	a4,-1452(a4) # ffffffffc0206fc0 <nbase>
ffffffffc0204574:	8f99                	sub	a5,a5,a4
ffffffffc0204576:	079a                	slli	a5,a5,0x6
ffffffffc0204578:	00011517          	auipc	a0,0x11
ffffffffc020457c:	ff853503          	ld	a0,-8(a0) # ffffffffc0215570 <pages>
ffffffffc0204580:	953e                	add	a0,a0,a5
ffffffffc0204582:	4589                	li	a1,2
ffffffffc0204584:	d3afd0ef          	jal	ra,ffffffffc0201abe <free_pages>
    kfree(proc);
ffffffffc0204588:	854e                	mv	a0,s3
ffffffffc020458a:	b74fd0ef          	jal	ra,ffffffffc02018fe <kfree>
    ret = -E_NO_MEM;
ffffffffc020458e:	5571                	li	a0,-4
    goto fork_out;
ffffffffc0204590:	b70d                	j	ffffffffc02044b2 <do_fork+0x150>
    int ret = -E_NO_FREE_PROC;
ffffffffc0204592:	556d                	li	a0,-5
ffffffffc0204594:	bf39                	j	ffffffffc02044b2 <do_fork+0x150>
    return last_pid;
ffffffffc0204596:	00082503          	lw	a0,0(a6)
ffffffffc020459a:	b5d9                	j	ffffffffc0204460 <do_fork+0xfe>
    ret = -E_NO_MEM;
ffffffffc020459c:	5571                	li	a0,-4
    return ret;
ffffffffc020459e:	bf11                	j	ffffffffc02044b2 <do_fork+0x150>
    assert(current->mm == NULL);
ffffffffc02045a0:	00002697          	auipc	a3,0x2
ffffffffc02045a4:	68068693          	addi	a3,a3,1664 # ffffffffc0206c20 <default_pmm_manager+0xff0>
ffffffffc02045a8:	00001617          	auipc	a2,0x1
ffffffffc02045ac:	2d860613          	addi	a2,a2,728 # ffffffffc0205880 <commands+0x738>
ffffffffc02045b0:	10a00593          	li	a1,266
ffffffffc02045b4:	00002517          	auipc	a0,0x2
ffffffffc02045b8:	68450513          	addi	a0,a0,1668 # ffffffffc0206c38 <default_pmm_manager+0x1008>
ffffffffc02045bc:	e8bfb0ef          	jal	ra,ffffffffc0200446 <__panic>
    return KADDR(page2pa(page));
ffffffffc02045c0:	00001617          	auipc	a2,0x1
ffffffffc02045c4:	6a860613          	addi	a2,a2,1704 # ffffffffc0205c68 <default_pmm_manager+0x38>
ffffffffc02045c8:	06900593          	li	a1,105
ffffffffc02045cc:	00001517          	auipc	a0,0x1
ffffffffc02045d0:	6c450513          	addi	a0,a0,1732 # ffffffffc0205c90 <default_pmm_manager+0x60>
ffffffffc02045d4:	e73fb0ef          	jal	ra,ffffffffc0200446 <__panic>
        panic("pa2page called with invalid pa");
ffffffffc02045d8:	00001617          	auipc	a2,0x1
ffffffffc02045dc:	76060613          	addi	a2,a2,1888 # ffffffffc0205d38 <default_pmm_manager+0x108>
ffffffffc02045e0:	06200593          	li	a1,98
ffffffffc02045e4:	00001517          	auipc	a0,0x1
ffffffffc02045e8:	6ac50513          	addi	a0,a0,1708 # ffffffffc0205c90 <default_pmm_manager+0x60>
ffffffffc02045ec:	e5bfb0ef          	jal	ra,ffffffffc0200446 <__panic>
    return pa2page(PADDR(kva));
ffffffffc02045f0:	00001617          	auipc	a2,0x1
ffffffffc02045f4:	72060613          	addi	a2,a2,1824 # ffffffffc0205d10 <default_pmm_manager+0xe0>
ffffffffc02045f8:	06e00593          	li	a1,110
ffffffffc02045fc:	00001517          	auipc	a0,0x1
ffffffffc0204600:	69450513          	addi	a0,a0,1684 # ffffffffc0205c90 <default_pmm_manager+0x60>
...
ffffffffc020461e:	fe06                	sd	ra,312(sp)
    memset(&tf, 0, sizeof(struct trapframe));
ffffffffc0204620:	06f000ef          	jal	ra,ffffffffc0204e8e <memset>
...
ffffffffc0204646:	e63e                	sd	a5,264(sp)
    return do_fork(clone_flags | CLONE_VM, 0, &tf);
ffffffffc0204648:	d1bff0ef          	jal	ra,ffffffffc0204362 <do_fork>
}
...
ffffffffc020465e:	5f660613          	addi	a2,a2,1526 # ffffffffc0206c50 <default_pmm_manager+0x1020>
ffffffffc0204662:	16900593          	li	a1,361
ffffffffc0204666:	00002517          	auipc	a0,0x2
ffffffffc020466a:	5d250513          	addi	a0,a0,1490 # ffffffffc0206c38 <default_pmm_manager+0x1008>
do_exit(int error_code) {
...
ffffffffc02046a8:	b73ff0ef          	jal	ra,ffffffffc020421a <alloc_proc>
...
ffffffffc02046c0:	98efd0ef          	jal	ra,ffffffffc020184e <kmalloc>
...
ffffffffc02046ca:	842a                	mv	s0,a0
    memset(context_mem, 0, sizeof(struct context));
ffffffffc02046cc:	7c2000ef          	jal	ra,ffffffffc0204e8e <memset>
...
ffffffffc02046de:	7da000ef          	jal	ra,ffffffffc0204eb8 <memcmp>
ffffffffc02046e2:	89aa                	mv	s3,a0

    int *proc_name_mem = (int*) kmalloc(PROC_NAME_LEN);
ffffffffc02046e4:	453d                	li	a0,15
ffffffffc02046e6:	968fd0ef          	jal	ra,ffffffffc020184e <kmalloc>
...
ffffffffc02046ee:	842a                	mv	s0,a0
    memset(proc_name_mem, 0, PROC_NAME_LEN);
ffffffffc02046f0:	79e000ef          	jal	ra,ffffffffc0204e8e <memset>
...
ffffffffc0204700:	7b8000ef          	jal	ra,ffffffffc0204eb8 <memcmp>

    if(idleproc->cr3 == boot_cr3 && idleproc->tf == NULL && !context_init_flag
ffffffffc0204704:	00093783          	ld	a5,0(s2)
ffffffffc0204708:	00011717          	auipc	a4,0x11
ffffffffc020470c:	e5073703          	ld	a4,-432(a4) # ffffffffc0215558 <boot_cr3>
...
ffffffffc0204732:	75c000ef          	jal	ra,ffffffffc0204e8e <memset>
    return memcpy(proc->name, name, PROC_NAME_LEN);
ffffffffc0204736:	463d                	li	a2,15
ffffffffc0204738:	00002597          	auipc	a1,0x2
ffffffffc020473c:	56058593          	addi	a1,a1,1376 # ffffffffc0206c98 <default_pmm_manager+0x1068>
ffffffffc0204740:	8522                	mv	a0,s0
ffffffffc0204742:	75e000ef          	jal	ra,ffffffffc0204ea0 <memcpy>
...
ffffffffc020475c:	54858593          	addi	a1,a1,1352 # ffffffffc0206ca0 <default_pmm_manager+0x1070>
ffffffffc0204760:	00000517          	auipc	a0,0x0
ffffffffc0204764:	b2a50513          	addi	a0,a0,-1238 # ffffffffc020428a <init_main>
    nr_process ++;
...
ffffffffc020478c:	282000ef          	jal	ra,ffffffffc0204a0e <hash32>
...
ffffffffc02047c0:	e01c                	sd	a5,0(s0)
    memset(proc->name, 0, sizeof(proc->name));
ffffffffc02047c2:	6cc000ef          	jal	ra,ffffffffc0204e8e <memset>
    return memcpy(proc->name, name, PROC_NAME_LEN);
ffffffffc02047c6:	463d                	li	a2,15
ffffffffc02047c8:	00002597          	auipc	a1,0x2
ffffffffc02047cc:	50858593          	addi	a1,a1,1288 # ffffffffc0206cd0 <default_pmm_manager+0x10a0>
ffffffffc02047d0:	8526                	mv	a0,s1
ffffffffc02047d2:	6ce000ef          	jal	ra,ffffffffc0204ea0 <memcpy>
...
ffffffffc020483e:	44650513          	addi	a0,a0,1094 # ffffffffc0206c80 <default_pmm_manager+0x1050>
ffffffffc0204842:	93ffb0ef          	jal	ra,ffffffffc0200180 <cprintf>
    idleproc->pid = 0;
...
ffffffffc0204856:	41660613          	addi	a2,a2,1046 # ffffffffc0206c68 <default_pmm_manager+0x1038>
ffffffffc020485a:	18100593          	li	a1,385
ffffffffc020485e:	00002517          	auipc	a0,0x2
ffffffffc0204862:	3da50513          	addi	a0,a0,986 # ffffffffc0206c38 <default_pmm_manager+0x1008>
ffffffffc0204866:	be1fb0ef          	jal	ra,ffffffffc0200446 <__panic>
        panic("create init_main failed.\n");
ffffffffc020486a:	00002617          	auipc	a2,0x2
ffffffffc020486e:	44660613          	addi	a2,a2,1094 # ffffffffc0206cb0 <default_pmm_manager+0x1080>
ffffffffc0204872:	1a100593          	li	a1,417
ffffffffc0204876:	00002517          	auipc	a0,0x2
ffffffffc020487a:	3c250513          	addi	a0,a0,962 # ffffffffc0206c38 <default_pmm_manager+0x1008>
ffffffffc020487e:	bc9fb0ef          	jal	ra,ffffffffc0200446 <__panic>
    assert(initproc != NULL && initproc->pid == 1);
ffffffffc0204882:	00002697          	auipc	a3,0x2
ffffffffc0204886:	47e68693          	addi	a3,a3,1150 # ffffffffc0206d00 <default_pmm_manager+0x10d0>
ffffffffc020488a:	00001617          	auipc	a2,0x1
ffffffffc020488e:	ff660613          	addi	a2,a2,-10 # ffffffffc0205880 <commands+0x738>
ffffffffc0204892:	1a800593          	li	a1,424
ffffffffc0204896:	00002517          	auipc	a0,0x2
ffffffffc020489a:	3a250513          	addi	a0,a0,930 # ffffffffc0206c38 <default_pmm_manager+0x1008>
ffffffffc020489e:	ba9fb0ef          	jal	ra,ffffffffc0200446 <__panic>
    assert(idleproc != NULL && idleproc->pid == 0);
ffffffffc02048a2:	00002697          	auipc	a3,0x2
ffffffffc02048a6:	43668693          	addi	a3,a3,1078 # ffffffffc0206cd8 <default_pmm_manager+0x10a8>
ffffffffc02048aa:	00001617          	auipc	a2,0x1
ffffffffc02048ae:	fd660613          	addi	a2,a2,-42 # ffffffffc0205880 <commands+0x738>
ffffffffc02048b2:	1a700593          	li	a1,423
ffffffffc02048b6:	00002517          	auipc	a0,0x2
ffffffffc02048ba:	38250513          	addi	a0,a0,898 # ffffffffc0206c38 <default_pmm_manager+0x1008>
ffffffffc02048be:	b89fb0ef          	jal	ra,ffffffffc0200446 <__panic>
...
ffffffffc02048d6:	dff5                	beqz	a5,ffffffffc02048d2 <cpu_idle+0x10>
            schedule();
ffffffffc02048d8:	0a2000ef          	jal	ra,ffffffffc020497a <schedule>
ffffffffc02048dc:	bfd5                	j	ffffffffc02048d0 <cpu_idle+0xe>

ffffffffc02048de <switch_to>:
.text
...
ffffffffc02048de:	00153023          	sd	ra,0(a0)
    STORE sp, 1*REGBYTES(a0)
ffffffffc02048e2:	00253423          	sd	sp,8(a0)
    STORE s0, 2*REGBYTES(a0)
ffffffffc02048e6:	e900                	sd	s0,16(a0)
    STORE s1, 3*REGBYTES(a0)
ffffffffc02048e8:	ed04                	sd	s1,24(a0)
    STORE s2, 4*REGBYTES(a0)
ffffffffc02048ea:	03253023          	sd	s2,32(a0)
    STORE s3, 5*REGBYTES(a0)
ffffffffc02048ee:	03353423          	sd	s3,40(a0)
    STORE s4, 6*REGBYTES(a0)
ffffffffc02048f2:	03453823          	sd	s4,48(a0)
    STORE s5, 7*REGBYTES(a0)
ffffffffc02048f6:	03553c23          	sd	s5,56(a0)
    STORE s6, 8*REGBYTES(a0)
ffffffffc02048fa:	05653023          	sd	s6,64(a0)
    STORE s7, 9*REGBYTES(a0)
ffffffffc02048fe:	05753423          	sd	s7,72(a0)
    STORE s8, 10*REGBYTES(a0)
ffffffffc0204902:	05853823          	sd	s8,80(a0)
    STORE s9, 11*REGBYTES(a0)
ffffffffc0204906:	05953c23          	sd	s9,88(a0)
    STORE s10, 12*REGBYTES(a0)
ffffffffc020490a:	07a53023          	sd	s10,96(a0)
    STORE s11, 13*REGBYTES(a0)
ffffffffc020490e:	07b53423          	sd	s11,104(a0)

    # restore to's registers
    LOAD ra, 0*REGBYTES(a1)
ffffffffc0204912:	0005b083          	ld	ra,0(a1)
    LOAD sp, 1*REGBYTES(a1)
ffffffffc0204916:	0085b103          	ld	sp,8(a1)
    LOAD s0, 2*REGBYTES(a1)
ffffffffc020491a:	6980                	ld	s0,16(a1)
    LOAD s1, 3*REGBYTES(a1)
ffffffffc020491c:	6d84                	ld	s1,24(a1)
    LOAD s2, 4*REGBYTES(a1)
ffffffffc020491e:	0205b903          	ld	s2,32(a1)
    LOAD s3, 5*REGBYTES(a1)
ffffffffc0204922:	0285b983          	ld	s3,40(a1)
    LOAD s4, 6*REGBYTES(a1)
ffffffffc0204926:	0305ba03          	ld	s4,48(a1)
    LOAD s5, 7*REGBYTES(a1)
ffffffffc020492a:	0385ba83          	ld	s5,56(a1)
    LOAD s6, 8*REGBYTES(a1)
ffffffffc020492e:	0405bb03          	ld	s6,64(a1)
    LOAD s7, 9*REGBYTES(a1)
ffffffffc0204932:	0485bb83          	ld	s7,72(a1)
    LOAD s8, 10*REGBYTES(a1)
ffffffffc0204936:	0505bc03          	ld	s8,80(a1)
    LOAD s9, 11*REGBYTES(a1)
ffffffffc020493a:	0585bc83          	ld	s9,88(a1)
    LOAD s10, 12*REGBYTES(a1)
ffffffffc020493e:	0605bd03          	ld	s10,96(a1)
    LOAD s11, 13*REGBYTES(a1)
ffffffffc0204942:	0685bd83          	ld	s11,104(a1)

    ret
ffffffffc0204946:	8082                	ret

ffffffffc0204948 <wakeup_proc>:
#include <sched.h>
#include <assert.h>
...
ffffffffc0204948:	411c                	lw	a5,0(a0)
ffffffffc020494a:	4705                	li	a4,1
ffffffffc020494c:	37f9                	addiw	a5,a5,-2
ffffffffc020494e:	00f77563          	bgeu	a4,a5,ffffffffc0204958 <wakeup_proc+0x10>
    proc->state = PROC_RUNNABLE;
ffffffffc0204952:	4789                	li	a5,2
ffffffffc0204954:	c11c                	sw	a5,0(a0)
ffffffffc0204956:	8082                	ret
wakeup_proc(struct proc_struct *proc) {
ffffffffc0204958:	1141                	addi	sp,sp,-16
    assert(proc->state != PROC_ZOMBIE && proc->state != PROC_RUNNABLE);
ffffffffc020495a:	00002697          	auipc	a3,0x2
ffffffffc020495e:	3ce68693          	addi	a3,a3,974 # ffffffffc0206d28 <default_pmm_manager+0x10f8>
ffffffffc0204962:	00001617          	auipc	a2,0x1
ffffffffc0204966:	f1e60613          	addi	a2,a2,-226 # ffffffffc0205880 <commands+0x738>
ffffffffc020496a:	45a5                	li	a1,9
ffffffffc020496c:	00002517          	auipc	a0,0x2
ffffffffc0204970:	3fc50513          	addi	a0,a0,1020 # ffffffffc0206d68 <default_pmm_manager+0x1138>
wakeup_proc(struct proc_struct *proc) {
ffffffffc0204974:	e406                	sd	ra,8(sp)
    assert(proc->state != PROC_ZOMBIE && proc->state != PROC_RUNNABLE);
ffffffffc0204976:	ad1fb0ef          	jal	ra,ffffffffc0200446 <__panic>

ffffffffc020497a <schedule>:
}
...
ffffffffc020497e:	e022                	sd	s0,0(sp)
    if (read_csr(sstatus) & SSTATUS_SIE) {
ffffffffc0204980:	100027f3          	csrr	a5,sstatus
ffffffffc0204984:	8b89                	andi	a5,a5,2
ffffffffc0204986:	4401                	li	s0,0
ffffffffc0204988:	efbd                	bnez	a5,ffffffffc0204a06 <schedule+0x8c>
    bool intr_flag;
...
ffffffffc020498a:	00011897          	auipc	a7,0x11
ffffffffc020498e:	c268b883          	ld	a7,-986(a7) # ffffffffc02155b0 <current>
ffffffffc0204992:	0008ac23          	sw	zero,24(a7)
        last = (current == idleproc) ? &proc_list : &(current->list_link);
ffffffffc0204996:	00011517          	auipc	a0,0x11
ffffffffc020499a:	c2253503          	ld	a0,-990(a0) # ffffffffc02155b8 <idleproc>
ffffffffc020499e:	04a88e63          	beq	a7,a0,ffffffffc02049fa <schedule+0x80>
ffffffffc02049a2:	0c888693          	addi	a3,a7,200
ffffffffc02049a6:	00011617          	auipc	a2,0x11
ffffffffc02049aa:	b8260613          	addi	a2,a2,-1150 # ffffffffc0215528 <proc_list>
        le = last;
...
ffffffffc02049b2:	4809                	li	a6,2
ffffffffc02049b4:	679c                	ld	a5,8(a5)
            if ((le = list_next(le)) != &proc_list) {
ffffffffc02049b6:	00c78863          	beq	a5,a2,ffffffffc02049c6 <schedule+0x4c>
                if (next->state == PROC_RUNNABLE) {
ffffffffc02049ba:	f387a703          	lw	a4,-200(a5)
                next = le2proc(le, list_link);
ffffffffc02049be:	f3878593          	addi	a1,a5,-200
                if (next->state == PROC_RUNNABLE) {
ffffffffc02049c2:	03070163          	beq	a4,a6,ffffffffc02049e4 <schedule+0x6a>
                    break;
                }
            }
        } while (le != last);
ffffffffc02049c6:	fef697e3          	bne	a3,a5,ffffffffc02049b4 <schedule+0x3a>
        if (next == NULL || next->state != PROC_RUNNABLE) {
ffffffffc02049ca:	ed89                	bnez	a1,ffffffffc02049e4 <schedule+0x6a>
            next = idleproc;
        }
        next->runs ++;
ffffffffc02049cc:	451c                	lw	a5,8(a0)
ffffffffc02049ce:	2785                	addiw	a5,a5,1
ffffffffc02049d0:	c51c                	sw	a5,8(a0)
        if (next != current) {
ffffffffc02049d2:	00a88463          	beq	a7,a0,ffffffffc02049da <schedule+0x60>
            proc_run(next);
ffffffffc02049d6:	927ff0ef          	jal	ra,ffffffffc02042fc <proc_run>
    if (flag) {
ffffffffc02049da:	e819                	bnez	s0,ffffffffc02049f0 <schedule+0x76>
        }
    }
    local_intr_restore(intr_flag);
}
...
ffffffffc02049e0:	0141                	addi	sp,sp,16
ffffffffc02049e2:	8082                	ret
        if (next == NULL || next->state != PROC_RUNNABLE) {
ffffffffc02049e4:	4198                	lw	a4,0(a1)
ffffffffc02049e6:	4789                	li	a5,2
ffffffffc02049e8:	fef712e3          	bne	a4,a5,ffffffffc02049cc <schedule+0x52>
ffffffffc02049ec:	852e                	mv	a0,a1
ffffffffc02049ee:	bff9                	j	ffffffffc02049cc <schedule+0x52>
}
ffffffffc02049f0:	6402                	ld	s0,0(sp)
ffffffffc02049f2:	60a2                	ld	ra,8(sp)
ffffffffc02049f4:	0141                	addi	sp,sp,16
        intr_enable();
ffffffffc02049f6:	bc7fb06f          	j	ffffffffc02005bc <intr_enable>
        last = (current == idleproc) ? &proc_list : &(current->list_link);
ffffffffc02049fa:	00011617          	auipc	a2,0x11
ffffffffc02049fe:	b2e60613          	addi	a2,a2,-1234 # ffffffffc0215528 <proc_list>
ffffffffc0204a02:	86b2                	mv	a3,a2
ffffffffc0204a04:	b76d                	j	ffffffffc02049ae <schedule+0x34>
        intr_disable();
ffffffffc0204a06:	bbdfb0ef          	jal	ra,ffffffffc02005c2 <intr_disable>
        return 1;
ffffffffc0204a0a:	4405                	li	s0,1
ffffffffc0204a0c:	bfbd                	j	ffffffffc020498a <schedule+0x10>

ffffffffc0204a0e <hash32>:
 *
...
ffffffffc0204a0e:	9e3707b7          	lui	a5,0x9e370
ffffffffc0204a12:	2785                	addiw	a5,a5,1
ffffffffc0204a14:	02a7853b          	mulw	a0,a5,a0
    return (hash >> (32 - bits));
ffffffffc0204a18:	02000793          	li	a5,32
ffffffffc0204a1c:	9f8d                	subw	a5,a5,a1
}
ffffffffc0204a1e:	00f5553b          	srlw	a0,a0,a5
ffffffffc0204a22:	8082                	ret

ffffffffc0204a24 <printnum>:
 * */
static void
...
ffffffffc0204a24:	02069813          	slli	a6,a3,0x20
        unsigned long long num, unsigned base, int width, int padc) {
ffffffffc0204a28:	7179                	addi	sp,sp,-48
    unsigned mod = do_div(result, base);
ffffffffc0204a2a:	02085813          	srli	a6,a6,0x20
        unsigned long long num, unsigned base, int width, int padc) {
ffffffffc0204a2e:	e052                	sd	s4,0(sp)
    unsigned mod = do_div(result, base);
ffffffffc0204a30:	03067a33          	remu	s4,a2,a6
        unsigned long long num, unsigned base, int width, int padc) {
ffffffffc0204a34:	f022                	sd	s0,32(sp)
ffffffffc0204a36:	ec26                	sd	s1,24(sp)
ffffffffc0204a38:	e84a                	sd	s2,16(sp)
ffffffffc0204a3a:	f406                	sd	ra,40(sp)
ffffffffc0204a3c:	e44e                	sd	s3,8(sp)
ffffffffc0204a3e:	84aa                	mv	s1,a0
ffffffffc0204a40:	892e                	mv	s2,a1
    ...
    if (num >= base) {
        ...
        while (-- width > 0)
ffffffffc0204a42:	fff7041b          	addiw	s0,a4,-1
    unsigned mod = do_div(result, base);
ffffffffc0204a46:	2a01                	sext.w	s4,s4
    if (num >= base) {
ffffffffc0204a48:	03067e63          	bgeu	a2,a6,ffffffffc0204a84 <printnum+0x60>
ffffffffc0204a4c:	89be                	mv	s3,a5
        while (-- width > 0)
ffffffffc0204a4e:	00805763          	blez	s0,ffffffffc0204a5c <printnum+0x38>
ffffffffc0204a52:	347d                	addiw	s0,s0,-1
            putch(padc, putdat);
ffffffffc0204a54:	85ca                	mv	a1,s2
ffffffffc0204a56:	854e                	mv	a0,s3
ffffffffc0204a58:	9482                	jalr	s1
        while (-- width > 0)
ffffffffc0204a5a:	fc65                	bnez	s0,ffffffffc0204a52 <printnum+0x2e>
    }
    // then print this (the least significant) digit
    putch("0123456789abcdef"[mod], putdat);
ffffffffc0204a5c:	1a02                	slli	s4,s4,0x20
ffffffffc0204a5e:	00002797          	auipc	a5,0x2
ffffffffc0204a62:	32278793          	addi	a5,a5,802 # ffffffffc0206d80 <default_pmm_manager+0x1150>
ffffffffc0204a66:	020a5a13          	srli	s4,s4,0x20
ffffffffc0204a6a:	9a3e                	add	s4,s4,a5
}
ffffffffc0204a6c:	7402                	ld	s0,32(sp)
    putch("0123456789abcdef"[mod], putdat);
ffffffffc0204a6e:	000a4503          	lbu	a0,0(s4)
}
ffffffffc0204a72:	70a2                	ld	ra,40(sp)
ffffffffc0204a74:	69a2                	ld	s3,8(sp)
ffffffffc0204a76:	6a02                	ld	s4,0(sp)
    putch("0123456789abcdef"[mod], putdat);
ffffffffc0204a78:	85ca                	mv	a1,s2
ffffffffc0204a7a:	87a6                	mv	a5,s1
}
ffffffffc0204a7c:	6942                	ld	s2,16(sp)
ffffffffc0204a7e:	64e2                	ld	s1,24(sp)
ffffffffc0204a80:	6145                	addi	sp,sp,48
    putch("0123456789abcdef"[mod], putdat);
ffffffffc0204a82:	8782                	jr	a5
        printnum(putch, putdat, result, base, width - 1, padc);
ffffffffc0204a84:	03065633          	divu	a2,a2,a6
ffffffffc0204a88:	8722                	mv	a4,s0
ffffffffc0204a8a:	f9bff0ef          	jal	ra,ffffffffc0204a24 <printnum>
ffffffffc0204a8e:	b7f9                	j	ffffffffc0204a5c <printnum+0x38>

ffffffffc0204a90 <vprintfmt>:
 *
 * Call this function if you are already dealing with a va_list.
...
ffffffffc0204a90:	7119                	addi	sp,sp,-128
ffffffffc0204a92:	f4a6                	sd	s1,104(sp)
ffffffffc0204a94:	f0ca                	sd	s2,96(sp)
ffffffffc0204a96:	ecce                	sd	s3,88(sp)
ffffffffc0204a98:	e8d2                	sd	s4,80(sp)
ffffffffc0204a9a:	e4d6                	sd	s5,72(sp)
ffffffffc0204a9c:	e0da                	sd	s6,64(sp)
ffffffffc0204a9e:	fc5e                	sd	s7,56(sp)
ffffffffc0204aa0:	f06a                	sd	s10,32(sp)
ffffffffc0204aa2:	fc86                	sd	ra,120(sp)
ffffffffc0204aa4:	f8a2                	sd	s0,112(sp)
ffffffffc0204aa6:	f862                	sd	s8,48(sp)
ffffffffc0204aa8:	f466                	sd	s9,40(sp)
ffffffffc0204aaa:	ec6e                	sd	s11,24(sp)
ffffffffc0204aac:	892a                	mv	s2,a0
ffffffffc0204aae:	84ae                	mv	s1,a1
ffffffffc0204ab0:	8d32                	mv	s10,a2
ffffffffc0204ab2:	8a36                	mv	s4,a3
    register int ch, err;
...
ffffffffc0204ab4:	02500993          	li	s3,37
            putch(ch, putdat);
        }
        ...
        char padc = ' ';
        width = precision = -1;
ffffffffc0204ab8:	5b7d                	li	s6,-1
ffffffffc0204aba:	00002a97          	auipc	s5,0x2
ffffffffc0204abe:	2f2a8a93          	addi	s5,s5,754 # ffffffffc0206dac <default_pmm_manager+0x117c>
        case 'e':
            err = va_arg(ap, int);
            if (err < 0) {
                err = -err;
...
ffffffffc0204ac2:	00002b97          	auipc	s7,0x2
ffffffffc0204ac6:	4c6b8b93          	addi	s7,s7,1222 # ffffffffc0206f88 <error_string>
        while ((ch = *(unsigned char *)fmt ++) != '%') {
ffffffffc0204aca:	000d4503          	lbu	a0,0(s10)
ffffffffc0204ace:	001d0413          	addi	s0,s10,1
ffffffffc0204ad2:	01350a63          	beq	a0,s3,ffffffffc0204ae6 <vprintfmt+0x56>
            if (ch == '\0') {
ffffffffc0204ad6:	c121                	beqz	a0,ffffffffc0204b16 <vprintfmt+0x86>
            putch(ch, putdat);
ffffffffc0204ad8:	85a6                	mv	a1,s1
        while ((ch = *(unsigned char *)fmt ++) != '%') {
ffffffffc0204ada:	0405                	addi	s0,s0,1
            putch(ch, putdat);
ffffffffc0204adc:	9902                	jalr	s2
        while ((ch = *(unsigned char *)fmt ++) != '%') {
ffffffffc0204ade:	fff44503          	lbu	a0,-1(s0)
ffffffffc0204ae2:	ff351ae3          	bne	a0,s3,ffffffffc0204ad6 <vprintfmt+0x46>
        switch (ch = *(unsigned char *)fmt ++) {
ffffffffc0204ae6:	00044603          	lbu	a2,0(s0)
        char padc = ' ';
ffffffffc0204aea:	02000793          	li	a5,32
        lflag = altflag = 0;
ffffffffc0204aee:	4c81                	li	s9,0
ffffffffc0204af0:	4881                	li	a7,0
        width = precision = -1;
ffffffffc0204af2:	5c7d                	li	s8,-1
ffffffffc0204af4:	5dfd                	li	s11,-1
ffffffffc0204af6:	05500513          	li	a0,85
                if (ch < '0' || ch > '9') {
ffffffffc0204afa:	4825                	li	a6,9
        switch (ch = *(unsigned char *)fmt ++) {
ffffffffc0204afc:	fdd6059b          	addiw	a1,a2,-35
ffffffffc0204b00:	0ff5f593          	zext.b	a1,a1
ffffffffc0204b04:	00140d13          	addi	s10,s0,1
ffffffffc0204b08:	04b56263          	bltu	a0,a1,ffffffffc0204b4c <vprintfmt+0xbc>
ffffffffc0204b0c:	058a                	slli	a1,a1,0x2
ffffffffc0204b0e:	95d6                	add	a1,a1,s5
ffffffffc0204b10:	4194                	lw	a3,0(a1)
ffffffffc0204b12:	96d6                	add	a3,a3,s5
ffffffffc0204b14:	8682                	jr	a3
            for (fmt --; fmt[-1] != '%'; fmt --)
                /* do nothing */;
            break;
        }
...
ffffffffc0204b16:	70e6                	ld	ra,120(sp)
ffffffffc0204b18:	7446                	ld	s0,112(sp)
ffffffffc0204b1a:	74a6                	ld	s1,104(sp)
ffffffffc0204b1c:	7906                	ld	s2,96(sp)
ffffffffc0204b1e:	69e6                	ld	s3,88(sp)
ffffffffc0204b20:	6a46                	ld	s4,80(sp)
ffffffffc0204b22:	6aa6                	ld	s5,72(sp)
ffffffffc0204b24:	6b06                	ld	s6,64(sp)
ffffffffc0204b26:	7be2                	ld	s7,56(sp)
ffffffffc0204b28:	7c42                	ld	s8,48(sp)
ffffffffc0204b2a:	7ca2                	ld	s9,40(sp)
ffffffffc0204b2c:	7d02                	ld	s10,32(sp)
ffffffffc0204b2e:	6de2                	ld	s11,24(sp)
ffffffffc0204b30:	6109                	addi	sp,sp,128
ffffffffc0204b32:	8082                	ret
            padc = '0';
ffffffffc0204b34:	87b2                	mv	a5,a2
            goto reswitch;
ffffffffc0204b36:	00144603          	lbu	a2,1(s0)
        switch (ch = *(unsigned char *)fmt ++) {
ffffffffc0204b3a:	846a                	mv	s0,s10
ffffffffc0204b3c:	00140d13          	addi	s10,s0,1
ffffffffc0204b40:	fdd6059b          	addiw	a1,a2,-35
ffffffffc0204b44:	0ff5f593          	zext.b	a1,a1
ffffffffc0204b48:	fcb572e3          	bgeu	a0,a1,ffffffffc0204b0c <vprintfmt+0x7c>
            putch('%', putdat);
ffffffffc0204b4c:	85a6                	mv	a1,s1
ffffffffc0204b4e:	02500513          	li	a0,37
ffffffffc0204b52:	9902                	jalr	s2
            for (fmt --; fmt[-1] != '%'; fmt --)
ffffffffc0204b54:	fff44783          	lbu	a5,-1(s0)
ffffffffc0204b58:	8d22                	mv	s10,s0
ffffffffc0204b5a:	f73788e3          	beq	a5,s3,ffffffffc0204aca <vprintfmt+0x3a>
ffffffffc0204b5e:	ffed4783          	lbu	a5,-2(s10)
ffffffffc0204b62:	1d7d                	addi	s10,s10,-1
ffffffffc0204b64:	ff379de3          	bne	a5,s3,ffffffffc0204b5e <vprintfmt+0xce>
ffffffffc0204b68:	b78d                	j	ffffffffc0204aca <vprintfmt+0x3a>
                precision = precision * 10 + ch - '0';
ffffffffc0204b6a:	fd060c1b          	addiw	s8,a2,-48
                ch = *fmt;
ffffffffc0204b6e:	00144603          	lbu	a2,1(s0)
        switch (ch = *(unsigned char *)fmt ++) {
ffffffffc0204b72:	846a                	mv	s0,s10
                if (ch < '0' || ch > '9') {
ffffffffc0204b74:	fd06069b          	addiw	a3,a2,-48
                ch = *fmt;
ffffffffc0204b78:	0006059b          	sext.w	a1,a2
                if (ch < '0' || ch > '9') {
ffffffffc0204b7c:	02d86463          	bltu	a6,a3,ffffffffc0204ba4 <vprintfmt+0x114>
                ch = *fmt;
ffffffffc0204b80:	00144603          	lbu	a2,1(s0)
                precision = precision * 10 + ch - '0';
ffffffffc0204b84:	002c169b          	slliw	a3,s8,0x2
ffffffffc0204b88:	0186873b          	addw	a4,a3,s8
ffffffffc0204b8c:	0017171b          	slliw	a4,a4,0x1
ffffffffc0204b90:	9f2d                	addw	a4,a4,a1
                if (ch < '0' || ch > '9') {
ffffffffc0204b92:	fd06069b          	addiw	a3,a2,-48
            for (precision = 0; ; ++ fmt) {
ffffffffc0204b96:	0405                	addi	s0,s0,1
                precision = precision * 10 + ch - '0';
ffffffffc0204b98:	fd070c1b          	addiw	s8,a4,-48
                ch = *fmt;
ffffffffc0204b9c:	0006059b          	sext.w	a1,a2
                if (ch < '0' || ch > '9') {
ffffffffc0204ba0:	fed870e3          	bgeu	a6,a3,ffffffffc0204b80 <vprintfmt+0xf0>
            if (width < 0)
ffffffffc0204ba4:	f40ddce3          	bgez	s11,ffffffffc0204afc <vprintfmt+0x6c>
                width = precision, precision = -1;
ffffffffc0204ba8:	8de2                	mv	s11,s8
ffffffffc0204baa:	5c7d                	li	s8,-1
ffffffffc0204bac:	bf81                	j	ffffffffc0204afc <vprintfmt+0x6c>
            if (width < 0)
ffffffffc0204bae:	fffdc693          	not	a3,s11
ffffffffc0204bb2:	96fd                	srai	a3,a3,0x3f
ffffffffc0204bb4:	00ddfdb3          	and	s11,s11,a3
        switch (ch = *(unsigned char *)fmt ++) {
ffffffffc0204bb8:	00144603          	lbu	a2,1(s0)
ffffffffc0204bbc:	2d81                	sext.w	s11,s11
ffffffffc0204bbe:	846a                	mv	s0,s10
            goto reswitch;
ffffffffc0204bc0:	bf35                	j	ffffffffc0204afc <vprintfmt+0x6c>
            precision = va_arg(ap, int);
ffffffffc0204bc2:	000a2c03          	lw	s8,0(s4)
        switch (ch = *(unsigned char *)fmt ++) {
ffffffffc0204bc6:	00144603          	lbu	a2,1(s0)
            precision = va_arg(ap, int);
ffffffffc0204bca:	0a21                	addi	s4,s4,8
        switch (ch = *(unsigned char *)fmt ++) {
ffffffffc0204bcc:	846a                	mv	s0,s10
            goto process_precision;
ffffffffc0204bce:	bfd9                	j	ffffffffc0204ba4 <vprintfmt+0x114>
    if (lflag >= 2) {
ffffffffc0204bd0:	4705                	li	a4,1
            precision = va_arg(ap, int);
ffffffffc0204bd2:	008a0593          	addi	a1,s4,8
    if (lflag >= 2) {
ffffffffc0204bd6:	01174463          	blt	a4,a7,ffffffffc0204bde <vprintfmt+0x14e>
    else if (lflag) {
ffffffffc0204bda:	1a088e63          	beqz	a7,ffffffffc0204d96 <vprintfmt+0x306>
        return va_arg(*ap, unsigned long);
ffffffffc0204bde:	000a3603          	ld	a2,0(s4)
ffffffffc0204be2:	46c1                	li	a3,16
ffffffffc0204be4:	8a2e                	mv	s4,a1
            printnum(putch, putdat, num, base, width, padc);
ffffffffc0204be6:	2781                	sext.w	a5,a5
ffffffffc0204be8:	876e                	mv	a4,s11
ffffffffc0204bea:	85a6                	mv	a1,s1
ffffffffc0204bec:	854a                	mv	a0,s2
ffffffffc0204bee:	e37ff0ef          	jal	ra,ffffffffc0204a24 <printnum>
            break;
ffffffffc0204bf2:	bde1                	j	ffffffffc0204aca <vprintfmt+0x3a>
            putch(va_arg(ap, int), putdat);
ffffffffc0204bf4:	000a2503          	lw	a0,0(s4)
ffffffffc0204bf8:	85a6                	mv	a1,s1
ffffffffc0204bfa:	0a21                	addi	s4,s4,8
ffffffffc0204bfc:	9902                	jalr	s2
            break;
ffffffffc0204bfe:	b5f1                	j	ffffffffc0204aca <vprintfmt+0x3a>
    if (lflag >= 2) {
ffffffffc0204c00:	4705                	li	a4,1
            precision = va_arg(ap, int);
ffffffffc0204c02:	008a0593          	addi	a1,s4,8
    if (lflag >= 2) {
ffffffffc0204c06:	01174463          	blt	a4,a7,ffffffffc0204c0e <vprintfmt+0x17e>
    else if (lflag) {
ffffffffc0204c0a:	18088163          	beqz	a7,ffffffffc0204d8c <vprintfmt+0x2fc>
        return va_arg(*ap, unsigned long);
ffffffffc0204c0e:	000a3603          	ld	a2,0(s4)
ffffffffc0204c12:	46a9                	li	a3,10
ffffffffc0204c14:	8a2e                	mv	s4,a1
ffffffffc0204c16:	bfc1                	j	ffffffffc0204be6 <vprintfmt+0x156>
        switch (ch = *(unsigned char *)fmt ++) {
ffffffffc0204c18:	00144603          	lbu	a2,1(s0)
            altflag = 1;
ffffffffc0204c1c:	4c85                	li	s9,1
        switch (ch = *(unsigned char *)fmt ++) {
ffffffffc0204c1e:	846a                	mv	s0,s10
            goto reswitch;
ffffffffc0204c20:	bdf1                	j	ffffffffc0204afc <vprintfmt+0x6c>
            putch(ch, putdat);
ffffffffc0204c22:	85a6                	mv	a1,s1
ffffffffc0204c24:	02500513          	li	a0,37
ffffffffc0204c28:	9902                	jalr	s2
            break;
ffffffffc0204c2a:	b545                	j	ffffffffc0204aca <vprintfmt+0x3a>
        switch (ch = *(unsigned char *)fmt ++) {
ffffffffc0204c2c:	00144603          	lbu	a2,1(s0)
            lflag ++;
ffffffffc0204c30:	2885                	addiw	a7,a7,1
        switch (ch = *(unsigned char *)fmt ++) {
ffffffffc0204c32:	846a                	mv	s0,s10
            goto reswitch;
ffffffffc0204c34:	b5e1                	j	ffffffffc0204afc <vprintfmt+0x6c>
    if (lflag >= 2) {
ffffffffc0204c36:	4705                	li	a4,1
            precision = va_arg(ap, int);
ffffffffc0204c38:	008a0593          	addi	a1,s4,8
    if (lflag >= 2) {
ffffffffc0204c3c:	01174463          	blt	a4,a7,ffffffffc0204c44 <vprintfmt+0x1b4>
    else if (lflag) {
ffffffffc0204c40:	14088163          	beqz	a7,ffffffffc0204d82 <vprintfmt+0x2f2>
        return va_arg(*ap, unsigned long);
ffffffffc0204c44:	000a3603          	ld	a2,0(s4)
ffffffffc0204c48:	46a1                	li	a3,8
ffffffffc0204c4a:	8a2e                	mv	s4,a1
ffffffffc0204c4c:	bf69                	j	ffffffffc0204be6 <vprintfmt+0x156>
            putch('0', putdat);
ffffffffc0204c4e:	03000513          	li	a0,48
ffffffffc0204c52:	85a6                	mv	a1,s1
ffffffffc0204c54:	e03e                	sd	a5,0(sp)
ffffffffc0204c56:	9902                	jalr	s2
            putch('x', putdat);
ffffffffc0204c58:	85a6                	mv	a1,s1
ffffffffc0204c5a:	07800513          	li	a0,120
...
ffffffffc0204c64:	46c1                	li	a3,16
            num = (unsigned long long)(uintptr_t)va_arg(ap, void *);
ffffffffc0204c66:	ff8a3603          	ld	a2,-8(s4)
            goto number;
ffffffffc0204c6a:	bfb5                	j	ffffffffc0204be6 <vprintfmt+0x156>
            if ((p = va_arg(ap, char *)) == NULL) {
ffffffffc0204c6c:	000a3403          	ld	s0,0(s4)
ffffffffc0204c70:	008a0713          	addi	a4,s4,8
ffffffffc0204c74:	e03a                	sd	a4,0(sp)
ffffffffc0204c76:	14040263          	beqz	s0,ffffffffc0204dba <vprintfmt+0x32a>
            if (width > 0 && padc != '-') {
ffffffffc0204c7a:	0fb05763          	blez	s11,ffffffffc0204d68 <vprintfmt+0x2d8>
ffffffffc0204c7e:	02d00693          	li	a3,45
ffffffffc0204c82:	0cd79163          	bne	a5,a3,ffffffffc0204d44 <vprintfmt+0x2b4>
            for (; (ch = *p ++) != '\0' && (precision < 0 || -- precision >= 0); width --) {
ffffffffc0204c86:	00044783          	lbu	a5,0(s0)
ffffffffc0204c8a:	0007851b          	sext.w	a0,a5
ffffffffc0204c8e:	cf85                	beqz	a5,ffffffffc0204cc6 <vprintfmt+0x236>
ffffffffc0204c90:	00140a13          	addi	s4,s0,1
                if (altflag && (ch < ' ' || ch > '~')) {
ffffffffc0204c94:	05e00413          	li	s0,94
            for (; (ch = *p ++) != '\0' && (precision < 0 || -- precision >= 0); width --) {
ffffffffc0204c98:	000c4563          	bltz	s8,ffffffffc0204ca2 <vprintfmt+0x212>
ffffffffc0204c9c:	3c7d                	addiw	s8,s8,-1
ffffffffc0204c9e:	036c0263          	beq	s8,s6,ffffffffc0204cc2 <vprintfmt+0x232>
                    putch('?', putdat);
ffffffffc0204ca2:	85a6                	mv	a1,s1
                if (altflag && (ch < ' ' || ch > '~')) {
ffffffffc0204ca4:	0e0c8e63          	beqz	s9,ffffffffc0204da0 <vprintfmt+0x310>
ffffffffc0204ca8:	3781                	addiw	a5,a5,-32
ffffffffc0204caa:	0ef47b63          	bgeu	s0,a5,ffffffffc0204da0 <vprintfmt+0x310>
                    putch('?', putdat);
ffffffffc0204cae:	03f00513          	li	a0,63
ffffffffc0204cb2:	9902                	jalr	s2
            for (; (ch = *p ++) != '\0' && (precision < 0 || -- precision >= 0); width --) {
ffffffffc0204cb4:	000a4783          	lbu	a5,0(s4)
ffffffffc0204cb8:	3dfd                	addiw	s11,s11,-1
ffffffffc0204cba:	0a05                	addi	s4,s4,1
ffffffffc0204cbc:	0007851b          	sext.w	a0,a5
ffffffffc0204cc0:	ffe1                	bnez	a5,ffffffffc0204c98 <vprintfmt+0x208>
            for (; width > 0; width --) {
ffffffffc0204cc2:	01b05963          	blez	s11,ffffffffc0204cd4 <vprintfmt+0x244>
ffffffffc0204cc6:	3dfd                	addiw	s11,s11,-1
                putch(' ', putdat);
ffffffffc0204cc8:	85a6                	mv	a1,s1
ffffffffc0204cca:	02000513          	li	a0,32
ffffffffc0204cce:	9902                	jalr	s2
            for (; width > 0; width --) {
ffffffffc0204cd0:	fe0d9be3          	bnez	s11,ffffffffc0204cc6 <vprintfmt+0x236>
            if ((p = va_arg(ap, char *)) == NULL) {
ffffffffc0204cd4:	6a02                	ld	s4,0(sp)
ffffffffc0204cd6:	bbd5                	j	ffffffffc0204aca <vprintfmt+0x3a>
    if (lflag >= 2) {
ffffffffc0204cd8:	4705                	li	a4,1
            precision = va_arg(ap, int);
ffffffffc0204cda:	008a0c93          	addi	s9,s4,8
    if (lflag >= 2) {
ffffffffc0204cde:	01174463          	blt	a4,a7,ffffffffc0204ce6 <vprintfmt+0x256>
    else if (lflag) {
ffffffffc0204ce2:	08088d63          	beqz	a7,ffffffffc0204d7c <vprintfmt+0x2ec>
        return va_arg(*ap, long);
ffffffffc0204ce6:	000a3403          	ld	s0,0(s4)
            if ((long long)num < 0) {
ffffffffc0204cea:	0a044d63          	bltz	s0,ffffffffc0204da4 <vprintfmt+0x314>
            num = getint(&ap, lflag);
ffffffffc0204cee:	8622                	mv	a2,s0
ffffffffc0204cf0:	8a66                	mv	s4,s9
ffffffffc0204cf2:	46a9                	li	a3,10
ffffffffc0204cf4:	bdcd                	j	ffffffffc0204be6 <vprintfmt+0x156>
            err = va_arg(ap, int);
ffffffffc0204cf6:	000a2783          	lw	a5,0(s4)
            if (err > MAXERROR || (p = error_string[err]) == NULL) {
ffffffffc0204cfa:	4719                	li	a4,6
            err = va_arg(ap, int);
ffffffffc0204cfc:	0a21                	addi	s4,s4,8
            if (err < 0) {
ffffffffc0204cfe:	41f7d69b          	sraiw	a3,a5,0x1f
ffffffffc0204d02:	8fb5                	xor	a5,a5,a3
ffffffffc0204d04:	40d786bb          	subw	a3,a5,a3
            if (err > MAXERROR || (p = error_string[err]) == NULL) {
ffffffffc0204d08:	02d74163          	blt	a4,a3,ffffffffc0204d2a <vprintfmt+0x29a>
ffffffffc0204d0c:	00369793          	slli	a5,a3,0x3
ffffffffc0204d10:	97de                	add	a5,a5,s7
ffffffffc0204d12:	639c                	ld	a5,0(a5)
ffffffffc0204d14:	cb99                	beqz	a5,ffffffffc0204d2a <vprintfmt+0x29a>
                printfmt(putch, putdat, "%s", p);
ffffffffc0204d16:	86be                	mv	a3,a5
ffffffffc0204d18:	00000617          	auipc	a2,0x0
ffffffffc0204d1c:	1f060613          	addi	a2,a2,496 # ffffffffc0204f08 <etext+0x2c>
ffffffffc0204d20:	85a6                	mv	a1,s1
ffffffffc0204d22:	854a                	mv	a0,s2
ffffffffc0204d24:	0ce000ef          	jal	ra,ffffffffc0204df2 <printfmt>
ffffffffc0204d28:	b34d                	j	ffffffffc0204aca <vprintfmt+0x3a>
                printfmt(putch, putdat, "error %d", err);
ffffffffc0204d2a:	00002617          	auipc	a2,0x2
ffffffffc0204d2e:	07660613          	addi	a2,a2,118 # ffffffffc0206da0 <default_pmm_manager+0x1170>
ffffffffc0204d32:	85a6                	mv	a1,s1
ffffffffc0204d34:	854a                	mv	a0,s2
ffffffffc0204d36:	0bc000ef          	jal	ra,ffffffffc0204df2 <printfmt>
ffffffffc0204d3a:	bb41                	j	ffffffffc0204aca <vprintfmt+0x3a>
                p = "(null)";
ffffffffc0204d3c:	00002417          	auipc	s0,0x2
ffffffffc0204d40:	05c40413          	addi	s0,s0,92 # ffffffffc0206d98 <default_pmm_manager+0x1168>
                for (width -= strnlen(p, precision); width > 0; width --) {
ffffffffc0204d44:	85e2                	mv	a1,s8
ffffffffc0204d46:	8522                	mv	a0,s0
ffffffffc0204d48:	e43e                	sd	a5,8(sp)
ffffffffc0204d4a:	0e2000ef          	jal	ra,ffffffffc0204e2c <strnlen>
ffffffffc0204d4e:	40ad8dbb          	subw	s11,s11,a0
ffffffffc0204d52:	01b05b63          	blez	s11,ffffffffc0204d68 <vprintfmt+0x2d8>
                    putch(padc, putdat);
ffffffffc0204d56:	67a2                	ld	a5,8(sp)
ffffffffc0204d58:	00078a1b          	sext.w	s4,a5
                for (width -= strnlen(p, precision); width > 0; width --) {
ffffffffc0204d5c:	3dfd                	addiw	s11,s11,-1
                    putch(padc, putdat);
ffffffffc0204d5e:	85a6                	mv	a1,s1
ffffffffc0204d60:	8552                	mv	a0,s4
ffffffffc0204d62:	9902                	jalr	s2
                for (width -= strnlen(p, precision); width > 0; width --) {
ffffffffc0204d64:	fe0d9ce3          	bnez	s11,ffffffffc0204d5c <vprintfmt+0x2cc>
            for (; (ch = *p ++) != '\0' && (precision < 0 || -- precision >= 0); width --) {
ffffffffc0204d68:	00044783          	lbu	a5,0(s0)
ffffffffc0204d6c:	00140a13          	addi	s4,s0,1
ffffffffc0204d70:	0007851b          	sext.w	a0,a5
ffffffffc0204d74:	d3a5                	beqz	a5,ffffffffc0204cd4 <vprintfmt+0x244>
                if (altflag && (ch < ' ' || ch > '~')) {
ffffffffc0204d76:	05e00413          	li	s0,94
ffffffffc0204d7a:	bf39                	j	ffffffffc0204c98 <vprintfmt+0x208>
        return va_arg(*ap, int);
ffffffffc0204d7c:	000a2403          	lw	s0,0(s4)
ffffffffc0204d80:	b7ad                	j	ffffffffc0204cea <vprintfmt+0x25a>
        return va_arg(*ap, unsigned int);
ffffffffc0204d82:	000a6603          	lwu	a2,0(s4)
ffffffffc0204d86:	46a1                	li	a3,8
ffffffffc0204d88:	8a2e                	mv	s4,a1
ffffffffc0204d8a:	bdb1                	j	ffffffffc0204be6 <vprintfmt+0x156>
ffffffffc0204d8c:	000a6603          	lwu	a2,0(s4)
ffffffffc0204d90:	46a9                	li	a3,10
ffffffffc0204d92:	8a2e                	mv	s4,a1
ffffffffc0204d94:	bd89                	j	ffffffffc0204be6 <vprintfmt+0x156>
ffffffffc0204d96:	000a6603          	lwu	a2,0(s4)
ffffffffc0204d9a:	46c1                	li	a3,16
ffffffffc0204d9c:	8a2e                	mv	s4,a1
ffffffffc0204d9e:	b5a1                	j	ffffffffc0204be6 <vprintfmt+0x156>
                    putch(ch, putdat);
ffffffffc0204da0:	9902                	jalr	s2
ffffffffc0204da2:	bf09                	j	ffffffffc0204cb4 <vprintfmt+0x224>
                putch('-', putdat);
ffffffffc0204da4:	85a6                	mv	a1,s1
ffffffffc0204da6:	02d00513          	li	a0,45
ffffffffc0204daa:	e03e                	sd	a5,0(sp)
ffffffffc0204dac:	9902                	jalr	s2
                num = -(long long)num;
ffffffffc0204dae:	6782                	ld	a5,0(sp)
ffffffffc0204db0:	8a66                	mv	s4,s9
ffffffffc0204db2:	40800633          	neg	a2,s0
ffffffffc0204db6:	46a9                	li	a3,10
ffffffffc0204db8:	b53d                	j	ffffffffc0204be6 <vprintfmt+0x156>
            if (width > 0 && padc != '-') {
ffffffffc0204dba:	03b05163          	blez	s11,ffffffffc0204ddc <vprintfmt+0x34c>
ffffffffc0204dbe:	02d00693          	li	a3,45
ffffffffc0204dc2:	f6d79de3          	bne	a5,a3,ffffffffc0204d3c <vprintfmt+0x2ac>
                p = "(null)";
ffffffffc0204dc6:	00002417          	auipc	s0,0x2
ffffffffc0204dca:	fd240413          	addi	s0,s0,-46 # ffffffffc0206d98 <default_pmm_manager+0x1168>
            for (; (ch = *p ++) != '\0' && (precision < 0 || -- precision >= 0); width --) {
ffffffffc0204dce:	02800793          	li	a5,40
ffffffffc0204dd2:	02800513          	li	a0,40
ffffffffc0204dd6:	00140a13          	addi	s4,s0,1
ffffffffc0204dda:	bd6d                	j	ffffffffc0204c94 <vprintfmt+0x204>
ffffffffc0204ddc:	00002a17          	auipc	s4,0x2
ffffffffc0204de0:	fbda0a13          	addi	s4,s4,-67 # ffffffffc0206d99 <default_pmm_manager+0x1169>
ffffffffc0204de4:	02800513          	li	a0,40
ffffffffc0204de8:	02800793          	li	a5,40
                if (altflag && (ch < ' ' || ch > '~')) {
ffffffffc0204dec:	05e00413          	li	s0,94
ffffffffc0204df0:	b565                	j	ffffffffc0204c98 <vprintfmt+0x208>

ffffffffc0204df2 <printfmt>:
printfmt(void (*putch)(int, void*), void *putdat, const char *fmt, ...) {
ffffffffc0204df2:	715d                	addi	sp,sp,-80
    va_start(ap, fmt);
ffffffffc0204df4:	02810313          	addi	t1,sp,40
printfmt(void (*putch)(int, void*), void *putdat, const char *fmt, ...) {
ffffffffc0204df8:	f436                	sd	a3,40(sp)
    vprintfmt(putch, putdat, fmt, ap);
ffffffffc0204dfa:	869a                	mv	a3,t1
printfmt(void (*putch)(int, void*), void *putdat, const char *fmt, ...) {
ffffffffc0204dfc:	ec06                	sd	ra,24(sp)
ffffffffc0204dfe:	f83a                	sd	a4,48(sp)
ffffffffc0204e00:	fc3e                	sd	a5,56(sp)
ffffffffc0204e02:	e0c2                	sd	a6,64(sp)
ffffffffc0204e04:	e4c6                	sd	a7,72(sp)
    va_start(ap, fmt);
ffffffffc0204e06:	e41a                	sd	t1,8(sp)
    vprintfmt(putch, putdat, fmt, ap);
ffffffffc0204e08:	c89ff0ef          	jal	ra,ffffffffc0204a90 <vprintfmt>
}
ffffffffc0204e0c:	60e2                	ld	ra,24(sp)
ffffffffc0204e0e:	6161                	addi	sp,sp,80
ffffffffc0204e10:	8082                	ret

ffffffffc0204e12 <strlen>:
...
strlen(const char *s) {
ffffffffc0204e16:	872a                	mv	a4,a0
    size_t cnt = 0;
ffffffffc0204e18:	4501                	li	a0,0
    while (*s ++ != '\0') {
ffffffffc0204e1a:	cb81                	beqz	a5,ffffffffc0204e2a <strlen+0x18>
        cnt ++;
ffffffffc0204e1c:	0505                	addi	a0,a0,1
    while (*s ++ != '\0') {
ffffffffc0204e1e:	00a707b3          	add	a5,a4,a0
ffffffffc0204e22:	0007c783          	lbu	a5,0(a5)
ffffffffc0204e26:	fbfd                	bnez	a5,ffffffffc0204e1c <strlen+0xa>
...
ffffffffc0204e2c:	4781                	li	a5,0
    while (cnt < len && *s ++ != '\0') {
ffffffffc0204e2e:	e589                	bnez	a1,ffffffffc0204e38 <strnlen+0xc>
ffffffffc0204e30:	a811                	j	ffffffffc0204e44 <strnlen+0x18>
        cnt ++;
ffffffffc0204e32:	0785                	addi	a5,a5,1
    while (cnt < len && *s ++ != '\0') {
ffffffffc0204e34:	00f58863          	beq	a1,a5,ffffffffc0204e44 <strnlen+0x18>
ffffffffc0204e38:	00f50733          	add	a4,a0,a5
ffffffffc0204e3c:	00074703          	lbu	a4,0(a4)
ffffffffc0204e40:	fb6d                	bnez	a4,ffffffffc0204e32 <strnlen+0x6>
ffffffffc0204e42:	85be                	mv	a1,a5
    }
    return cnt;
}
ffffffffc0204e44:	852e                	mv	a0,a1
ffffffffc0204e46:	8082                	ret

ffffffffc0204e48 <strcpy>:
char *
...
#else
    char *p = dst;
ffffffffc0204e48:	87aa                	mv	a5,a0
    while ((*p ++ = *src ++) != '\0')
ffffffffc0204e4a:	0005c703          	lbu	a4,0(a1)
ffffffffc0204e4e:	0785                	addi	a5,a5,1
ffffffffc0204e50:	0585                	addi	a1,a1,1
ffffffffc0204e52:	fee78fa3          	sb	a4,-1(a5)
ffffffffc0204e56:	fb75                	bnez	a4,ffffffffc0204e4a <strcpy+0x2>
        /* nothing */;
    return dst;
...
ffffffffc0204e5e:	0005c703          	lbu	a4,0(a1)
    while (*s1 != '\0' && *s1 == *s2) {
ffffffffc0204e62:	cb89                	beqz	a5,ffffffffc0204e74 <strcmp+0x1a>
        s1 ++, s2 ++;
ffffffffc0204e64:	0505                	addi	a0,a0,1
ffffffffc0204e66:	0585                	addi	a1,a1,1
    while (*s1 != '\0' && *s1 == *s2) {
ffffffffc0204e68:	fee789e3          	beq	a5,a4,ffffffffc0204e5a <strcmp>
    return (int)((unsigned char)*s1 - (unsigned char)*s2);
ffffffffc0204e6c:	0007851b          	sext.w	a0,a5
#endif /* __HAVE_ARCH_STRCMP */
}
ffffffffc0204e70:	9d19                	subw	a0,a0,a4
ffffffffc0204e72:	8082                	ret
ffffffffc0204e74:	4501                	li	a0,0
ffffffffc0204e76:	bfed                	j	ffffffffc0204e70 <strcmp+0x16>

ffffffffc0204e78 <strchr>:
...
ffffffffc0204e7c:	c799                	beqz	a5,ffffffffc0204e8a <strchr+0x12>
        if (*s == c) {
ffffffffc0204e7e:	00f58763          	beq	a1,a5,ffffffffc0204e8c <strchr+0x14>
    while (*s != '\0') {
ffffffffc0204e82:	00154783          	lbu	a5,1(a0)
            return (char *)s;
        }
        s ++;
ffffffffc0204e86:	0505                	addi	a0,a0,1
    while (*s != '\0') {
ffffffffc0204e88:	fbfd                	bnez	a5,ffffffffc0204e7e <strchr+0x6>
    }
    return NULL;
...
ffffffffc0204ea4:	87aa                	mv	a5,a0
        *d ++ = *s ++;
ffffffffc0204ea6:	0005c703          	lbu	a4,0(a1)
...
memcmp(const void *v1, const void *v2, size_t n) {
    ...
    while (n -- > 0) {
ffffffffc0204eb8:	c205                	beqz	a2,ffffffffc0204ed8 <memcmp+0x20>
ffffffffc0204eba:	962e                	add	a2,a2,a1
ffffffffc0204ebc:	a019                	j	ffffffffc0204ec2 <memcmp+0xa>
ffffffffc0204ebe:	00c58d63          	beq	a1,a2,ffffffffc0204ed8 <memcmp+0x20>
        if (*s1 != *s2) {
ffffffffc0204ec2:	00054783          	lbu	a5,0(a0)
ffffffffc0204ec6:	0005c703          	lbu	a4,0(a1)
            return (int)((unsigned char)*s1 - (unsigned char)*s2);
        }
        s1 ++, s2 ++;
ffffffffc0204eca:	0505                	addi	a0,a0,1
ffffffffc0204ecc:	0585                	addi	a1,a1,1
        if (*s1 != *s2) {
ffffffffc0204ece:	fee788e3          	beq	a5,a4,ffffffffc0204ebe <memcmp+0x6>
            return (int)((unsigned char)*s1 - (unsigned char)*s2);
